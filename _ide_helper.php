...
namespace {
    ...
    class App extends \Illuminate\Support\Facades\App
    {
        ...
        {
            \Illuminate\Foundation\Application::beforeBootstrapping($bootstrapper,
                $callback);
        }
        ...
        {
            \Illuminate\Foundation\Application::afterBootstrapping($bootstrapper,
                $callback);
        }
        ...
        public static function register(
            ...
            return \Illuminate\Foundation\Application::register($provider,
                $options, $force);
        }
        ...
        public static function registerDeferredProvider(
            ...
            \Illuminate\Foundation\Application::registerDeferredProvider($provider,
                $service);
        }
        ...
        {
            return \Illuminate\Foundation\Application::handle($request, $type,
                $catch);
        }
        ...
        {
            \Illuminate\Foundation\Application::abort($code, $message,
                $headers);
        }
        ...
        public static function bind(
            ...
            //Method inherited from \Illuminate\Container\Container            
            \Illuminate\Foundation\Application::bind($abstract, $concrete,
                $shared);
        }
        ...
        public static function addContextualBinding(
            ...
            //Method inherited from \Illuminate\Container\Container            
            \Illuminate\Foundation\Application::addContextualBinding($concrete,
        ...
        public static function bindIf(
            ...
            //Method inherited from \Illuminate\Container\Container            
            \Illuminate\Foundation\Application::bindIf($abstract, $concrete,
                $shared);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return \Illuminate\Foundation\Application::rebinding($abstract,
                $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return \Illuminate\Foundation\Application::refresh($abstract,
                $target, $method);
        }
        ...
        /**
         * Wrap the given closure such that its dependencies will be injected
         * when executed.
         *
         * @param \Closure $callback
         * @param array    $parameters
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return \Illuminate\Foundation\Application::wrap($callback,
                $parameters);
        }
        ...
        public static function call(
            ...
            //Method inherited from \Illuminate\Container\Container            
            return \Illuminate\Foundation\Application::call($callback,
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            \Illuminate\Foundation\Application::afterResolving($abstract,
                $callback);
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth
    {
        ...
        {
            return \Illuminate\Auth\AuthManager::createSessionDriver($name,
                $config);
        }
        ...
        {
            return \Illuminate\Auth\AuthManager::createTokenDriver($name,
                $config);
        }
        ...
        {
            return \Illuminate\Auth\SessionGuard::basic($field,
                $extraConditions);
        }
        ...
        public static function attempt(
            ...
            return \Illuminate\Auth\SessionGuard::attempt($credentials,
                $remember, $login);
        }
    ...
    class Blade extends \Illuminate\Support\Facades\Blade
    {
        ...
        {
            \Illuminate\View\Compilers\BladeCompiler::directive($name,
                $handler);
        }
        ...
        {
            \Illuminate\View\Compilers\BladeCompiler::setRawTags($openTag,
                $closeTag);
        }
         ...
         * @static
         */
        public static function setContentTags(
            $openTag,
            $closeTag,
            $escaped = false
        ) {
            \Illuminate\View\Compilers\BladeCompiler::setContentTags($openTag,
                $closeTag, $escaped);
        }
        ...
        {
            \Illuminate\View\Compilers\BladeCompiler::setEscapedContentTags($openTag,
                $closeTag);
        }
    ...
    class Cache extends \Illuminate\Support\Facades\Cache
    {
        ...
        {
            return \Illuminate\Cache\Repository::remember($key, $minutes,
                $callback);
        }
        ...
        {
            return \Illuminate\Cache\Repository::rememberForever($key,
                $callback);
        }
        ...
        {
            return \Illuminate\Cache\Repository::macroCall($method,
                $parameters);
        }
    ...
    class Cookie extends \Illuminate\Support\Facades\Cookie
    {
        ...
        public static function make(
            ...
            return \Illuminate\Cookie\CookieJar::make($name, $value, $minutes,
        ...
        public static function forever(
            ...
            return \Illuminate\Cookie\CookieJar::forever($name, $value, $path,
        ...
        public static function setDefaultPathAndDomain(
            ...
            return \Illuminate\Cookie\CookieJar::setDefaultPathAndDomain($path,
                $domain, $secure);
        }
    ...
    class DB extends \Illuminate\Support\Facades\DB
    {
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::selectOne($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::selectFromWriteConnection($query,
                $bindings);
        }
        ...
        public static function select(
            ...
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::select($query,
                $bindings, $useReadPdo);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::insert($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::update($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::delete($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::statement($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::affectingStatement($query,
                $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            \Illuminate\Database\MySqlConnection::logQuery($query, $bindings,
                $time);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Illuminate\Database\MySqlConnection::getDoctrineColumn($table,
                $column);
        }
        ...
        /**
         * Set the default fetch mode for the connection, and optional
         * arguments for the given fetch mode.
         *
         * @param int   $fetchMode
        ...
        public static function setFetchMode(
            ...
            return \Illuminate\Database\MySqlConnection::setFetchMode($fetchMode,
                $fetchArgument, $fetchConstructorArgument);
        }
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::withGlobalScope($identifier,
                $scope);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::findMany($ids,
                $columns);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::findOrFail($id,
                $columns);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::findOrNew($id,
                $columns);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::updateOrCreate($attributes,
                $values);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::chunk($count,
                $callback);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::each($callback,
                $count);
        }
        ...
        public static function paginate(
            ...
            return \Illuminate\Database\Eloquent\Builder::paginate($perPage,
                $columns, $pageName, $page);
        }
        ...
        public static function simplePaginate(
            ...
            return \Illuminate\Database\Eloquent\Builder::simplePaginate($perPage,
                $columns, $pageName);
        }
        ...
        public static function where(
            ...
            return \Illuminate\Database\Eloquent\Builder::where($column,
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::orWhere($column,
                $operator, $value);
        }
        ...
        public static function has(
            ...
            return \Illuminate\Database\Eloquent\Builder::has($relation,
        ...
        public static function doesntHave(
            ...
            return \Illuminate\Database\Eloquent\Builder::doesntHave($relation,
                $boolean, $callback);
        }
        ...
        public static function whereHas(
            ...
            return \Illuminate\Database\Eloquent\Builder::whereHas($relation,
                $callback, $operator, $count);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::whereDoesntHave($relation,
                $callback);
        }
        ...
        {
            return \Illuminate\Database\Eloquent\Builder::orHas($relation,
                $operator, $count);
        }
        ...
        public static function orWhereHas(
            ...
            return \Illuminate\Database\Eloquent\Builder::orWhereHas($relation,
                $callback, $operator, $count);
        }
        ...
        public static function join(
            ...
            return \Illuminate\Database\Query\Builder::join($table, $one,
                $operator, $two, $type, $where);
        }
        ...
        public static function joinWhere(
            ...
            return \Illuminate\Database\Query\Builder::joinWhere($table, $one,
                $operator, $two, $type);
        }
        ...
        public static function leftJoin(
            ...
            return \Illuminate\Database\Query\Builder::leftJoin($table, $first,
                $operator, $second);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::leftJoinWhere($table,
                $one, $operator, $two);
        }
        ...
        public static function rightJoin(
            ...
            return \Illuminate\Database\Query\Builder::rightJoin($table, $first,
                $operator, $second);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::rightJoinWhere($table,
                $one, $operator, $two);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereRaw($sql, $bindings,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereRaw($sql,
                $bindings);
        }
        ...
        public static function whereBetween(
            ...
            return \Illuminate\Database\Query\Builder::whereBetween($column,
                $values, $boolean, $not);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereBetween($column,
                $values);
        }
        ...
        public static function whereNotBetween(
            ...
            return \Illuminate\Database\Query\Builder::whereNotBetween($column,
                $values, $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereNotBetween($column,
                $values);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereNested($callback,
                $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::addNestedWhereQuery($query,
                $boolean);
        }
        ...
        public static function whereExists(
            ...
            return \Illuminate\Database\Query\Builder::whereExists($callback,
                $boolean, $not);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereExists($callback,
                $not);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereNotExists($callback,
                $boolean);
        }
        ...
        public static function addWhereExistsQuery(
            ...
            return \Illuminate\Database\Query\Builder::addWhereExistsQuery($query,
                $boolean, $not);
        }
        ...
        public static function whereIn(
            ...
            return \Illuminate\Database\Query\Builder::whereIn($column, $values,
                $boolean, $not);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereIn($column,
                $values);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereNotIn($column,
                $values, $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereNotIn($column,
                $values);
        }
        ...
        public static function whereNull(
            ...
            return \Illuminate\Database\Query\Builder::whereNull($column,
                $boolean, $not);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::whereNotNull($column,
                $boolean);
        }
        ...
        public static function whereDate(
            ...
            return \Illuminate\Database\Query\Builder::whereDate($column,
                $operator, $value, $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orWhereDate($column,
                $operator, $value);
        }
        ...
        public static function whereDay(
            ...
            return \Illuminate\Database\Query\Builder::whereDay($column,
                $operator, $value, $boolean);
        }
        ...
        public static function whereMonth(
            ...
            return \Illuminate\Database\Query\Builder::whereMonth($column,
                $operator, $value, $boolean);
        }
        ...
        public static function whereYear(
            ...
            return \Illuminate\Database\Query\Builder::whereYear($column,
                $operator, $value, $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::dynamicWhere($method,
                $parameters);
        }
        ...
        public static function having(
            ...
            return \Illuminate\Database\Query\Builder::having($column,
                $operator, $value, $boolean);
        }
        ...
        public static function orHaving(
            ...
            return \Illuminate\Database\Query\Builder::orHaving($column,
                $operator, $value);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::havingRaw($sql,
                $bindings, $boolean);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orHavingRaw($sql,
                $bindings);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orderBy($column,
                $direction);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::orderByRaw($sql,
                $bindings);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::aggregate($function,
                $columns);
        }
        ...
        {
            return \Illuminate\Database\Query\Builder::insertGetId($values,
                $sequence);
        }
        ...
        public static function macroCall($method, $parameters)
        {
            return \Illuminate\Database\Query\Builder::macroCall($method,
                $parameters);
        }
    ...
    class File extends \Illuminate\Support\Facades\File
    {
        ...
        public static function makeDirectory(
            ...
            return \Illuminate\Filesystem\Filesystem::makeDirectory($path,
                $mode, $recursive, $force);
        }
        ...
        public static function copyDirectory(
            ...
            return \Illuminate\Filesystem\Filesystem::copyDirectory($directory,
                $destination, $options);
        }
        ...
        {
            return \Illuminate\Filesystem\Filesystem::deleteDirectory($directory,
                $preserve);
        }
    ...
    class Gate extends \Illuminate\Support\Facades\Gate
    {
        ...
        /**
         * Determine if the given ability should be granted for the current
         * user.
         *
         * @param string      $ability
        ...
        {
            return \Illuminate\Auth\Access\Gate::authorize($ability,
                $arguments);
        }
    ...
    class Hash extends \Illuminate\Support\Facades\Hash
    {
        ...
        {
            return \Illuminate\Hashing\BcryptHasher::check($value, $hashedValue,
                $options);
        }
        ...
        {
            return \Illuminate\Hashing\BcryptHasher::needsRehash($hashedValue,
                $options);
        }
    ...
    class Lang extends \Illuminate\Support\Facades\Lang
    {
        ...
        {
            return \Illuminate\Translation\Translator::hasForLocale($key,
                $locale);
        }
        ...
        public static function get(
            ...
            return \Illuminate\Translation\Translator::get($key, $replace,
                $locale, $fallback);
        }
        ...
        public static function choice(
            ...
            return \Illuminate\Translation\Translator::choice($key, $number,
                $replace, $locale);
        }
        ...
        public static function trans(
            ...
            return \Illuminate\Translation\Translator::trans($id, $parameters,
                $domain, $locale);
        }
        ...
        public static function transChoice(
            ...
            return \Illuminate\Translation\Translator::transChoice($id, $number,
        ...
        {
            \Illuminate\Translation\Translator::load($namespace, $group,
                $locale);
        }
    ...
    class Mail extends \Illuminate\Support\Facades\Mail
    {
        ...
        {
            return \Illuminate\Mail\Mailer::queue($view, $data, $callback,
                $queue);
        }
        ...
        {
            return \Illuminate\Mail\Mailer::onQueue($queue, $view, $data,
                $callback);
        }
         ...
         * Queue a new e-mail message for sending on the given queue.
         *
         * This method didn't match rest of framework's "onQueue" phrasing.
         * Added "onQueue".
         *
         * @param string          $queue
         * @param string|array    $view
        ...
        {
            return \Illuminate\Mail\Mailer::queueOn($queue, $view, $data,
                $callback);
        }
        ...
        public static function later(
            ...
            return \Illuminate\Mail\Mailer::later($delay, $view, $data,
                $callback, $queue);
        }
        ...
        /**
         * Queue a new e-mail message for sending after (n) seconds on the
         * given queue.
         *
         * @param string          $queue
         * @param int             $delay
    ...
    class Queue extends \Illuminate\Support\Facades\Queue
    {
        ...
        {
            return \Illuminate\Queue\SyncQueue::pushRaw($payload, $queue,
                $options);
        }
        ...
        {
            return \Illuminate\Queue\SyncQueue::later($delay, $job, $data,
                $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\SyncQueue::laterOn($queue, $delay, $job,
                $data);
        }
    ...
    class Redirect extends \Illuminate\Support\Facades\Redirect
    {
        ...
        /**
         * Create a new redirect response, while putting the current URL in the
         * session.
         *
         * @param string $path
         * @param int    $status
        ...
        public static function guest(
            ...
            return \Illuminate\Routing\Redirector::guest($path, $status,
                $headers, $secure);
        }
        ...
        public static function intended(
            ...
            return \Illuminate\Routing\Redirector::intended($default, $status,
                $headers, $secure);
        }
        ...
        public static function to(
            ...
            return \Illuminate\Routing\Redirector::to($path, $status, $headers,
                $secure);
        }
        ...
        {
            return \Illuminate\Routing\Redirector::away($path, $status,
                $headers);
        }
        ...
        {
            return \Illuminate\Routing\Redirector::secure($path, $status,
                $headers);
        }
        ...
        public static function route(
            ...
            return \Illuminate\Routing\Redirector::route($route, $parameters,
                $status, $headers);
        }
        ...
        public static function action(
            ...
            return \Illuminate\Routing\Redirector::action($action, $parameters,
                $status, $headers);
        }
    ...
    class Request extends \Illuminate\Support\Facades\Request
    {
        ...
        /**
         * Get the full URL for the request with the added query string
         * parameters.
         *
         * @param array $query
         *
        ...
        /**
         * Determine if the current request URL and query string matches a
         * pattern.
         *
         * @param mixed  string
         *
         ...
         * @param array $attributes The request attributes (parameters parsed
         *                          from the PATH_INFO, ...)
         * @param array $cookies    The COOKIE parameters
         * @param array $files      The FILES parameters
         * @param array $server     The SERVER parameters
         *
         * @return \Symfony\Component\HttpFoundation\Request The duplicated
         *                                                   request
         * @static
         */
        public static function duplicate(
            ...
            return \Illuminate\Http\Request::duplicate($query, $request,
                $attributes, $cookies, $files, $server);
        }
        ...
        public static function initialize(
            ...
            return \Illuminate\Http\Request::initialize($query, $request,
                $attributes, $cookies, $files, $server, $content);
        }
        ...
        /**
         * Overrides the PHP global variables according to this request
         * instance.
         *
         ...
         *
         *  * Request::HEADER_CLIENT_IP:    defaults to X-Forwarded-For   (see
         *  getClientIp())
         *  * Request::HEADER_CLIENT_HOST:  defaults to X-Forwarded-Host  (see
         *  getHost())
         *  * Request::HEADER_CLIENT_PORT:  defaults to X-Forwarded-Port  (see
         *  getPort())
         *  * Request::HEADER_CLIENT_PROTO: defaults to X-Forwarded-Proto (see
         *  getScheme() and isSecure())
         *
         * Setting an empty value allows to disable the trusted header for the
         * given key.
         *
         ...
         * alphabetized, have consistent escaping and unneeded delimiters are
         * removed.
         *
        ...
        /**
         * Enables support for the _method request parameter to determine the
         * intended HTTP method.
         *
         * Be warned that enabling this feature might lead to CSRF issues in
         * your code. Check that you are using CSRF tokens when required. If
         * the HTTP method parameter override is enabled, an html-form with
         * method "POST" can be altered and used to send a "PUT" or "DELETE"
         * request via the _method request parameter. If these methods are not
         * protected against CSRF, this presents a possible vulnerability.
         *
         * The HTTP method can only be overridden when the real HTTP method is
         * POST.
         *
         * @static
         */
         ...
         *
         * @return bool True when the _method request parameter is enabled,
         *              false otherwise
         * @static
         */
         ...
         * flexibility. If you don't need the flexibility in controllers, it is
         * better to explicitly get request parameters from the appropriate
         * public property instead (attributes, query, request).
         *
         * Order of precedence: PATH (routing placeholders or custom
         * attributes), GET, BODY
         *
         ...
         * Gets the Session.
         *
         * @return \Symfony\Component\HttpFoundation\SessionInterface|null The
         *                                                                 session
         * @static
         */
        public static function getSession()
        ...
        /**
         * Whether the request contains a Session which was started in one of
         ...
         *
         * This method does not give any information about the state of the
         * session object, like whether the session is started or not. It is
         * just a way to check if this Request is associated with a Session
         * instance.
         *
         * @return bool true when the Request contains a Session object, false
         *              otherwise
         * @static
         */
         ...
         * Sets the Session.
         *
         * @param \Symfony\Component\HttpFoundation\SessionInterface $session The
         *                                                                    Session
         *
         * @static
         */
         ...
         * Returns the client IP address.
         *
         * This method can read the client IP address from the
         * "X-Forwarded-For" header when trusted proxies were set via
         * "setTrustedProxies()". The "X-Forwarded-For" header value is a
         * comma+space separated list of IP addresses, the left-most being the
         * original client, and each successive proxy that passed the request
         * adding the IP address where it received the request from.
         *
         * If your reverse proxy uses a different header name than
         * "X-Forwarded-For",
         * ("Client-Ip" for instance), configure it via
         * "setTrustedHeaderName()" with the "client-ip" key.
         *
         ...
         *
         * This method can read the client port from the "X-Forwarded-Port"
         * header when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Port" header must contain the client port.
         *
         * If your reverse proxy uses a different header name than
         * "X-Forwarded-Port", configure it via "setTrustedHeaderName()" with
         * the "client-port" key.
         *
         * @return string
         * @static
         ...
         *                information about how to gain authorization to access
         *                the server
         * @static
         */
        ...
        /**
         * Returns the path as relative reference from the current Request
         * path.
         *
         * Only the URIs path component (no schema, host etc.) is relevant and
         * must be given. Both paths must be absolute and not contain relative
         * parts. Relative URLs from one resource to another are useful when
         * generating self-contained downloadable document archives.
         ...
         *
         * This method can read the client protocol from the
         * "X-Forwarded-Proto" header when trusted proxies were set via
         * "setTrustedProxies()".
         *
         ...
         * If your reverse proxy uses a different header name than
         * "X-Forwarded-Proto"
         * ("SSL_HTTPS" for instance), configure it via
         * "setTrustedHeaderName()" with the "client-proto" key.
         *
         * @return bool
         * @static
         */
         ...
         *
         * This method can read the client host name from the
         * "X-Forwarded-Host" header when trusted proxies were set via
         * "setTrustedProxies()".
         *
         * The "X-Forwarded-Host" header must contain the client host name.
         *
         * If your reverse proxy uses a different header name than
         * "X-Forwarded-Host", configure it via "setTrustedHeaderName()" with
         * the "client-host" key.
         *
         * @return string
         ...
         *
         * If the X-HTTP-Method-Override header is set, and if the method is a
         * POST, then it is used to determine the "real" intended HTTP method.
         *
         * The _method request parameter can also be used to determine the HTTP
         * method, but only if enableHttpMethodParameterOverride() has been
         * called.
         *
         ...
         *
         * @param string       $format    The format
         * @param string|array $mimeTypes The associated mime types (the
         *                                preferred one must be the first as it
         ...
         *
         * @return string|resource The request body content or a resource to
         ...
         *
         * It works if your JavaScript library sets an X-Requested-With HTTP
         * header. It is known to work with common JavaScript frameworks:
         *
         * @link http://en.wikipedia.org/wiki/List_of_Ajax_frameworks#JavaScript
         * @return bool true if the request is an XMLHttpRequest, false
         *              otherwise
         * @static
         */
    ...
    class Response extends \Illuminate\Support\Facades\Response
    {
        ...
        {
            return \Illuminate\Routing\ResponseFactory::make($content, $status,
                $headers);
        }
        ...
        public static function view(
            ...
            return \Illuminate\Routing\ResponseFactory::view($view, $data,
                $status, $headers);
        }
        ...
        public static function json(
            ...
            return \Illuminate\Routing\ResponseFactory::json($data, $status,
                $headers, $options);
        }
        ...
        public static function jsonp(
            ...
            return \Illuminate\Routing\ResponseFactory::jsonp($callback, $data,
        ...
        {
            return \Illuminate\Routing\ResponseFactory::stream($callback,
                $status, $headers);
        }
        ...
        public static function download(
            ...
            return \Illuminate\Routing\ResponseFactory::download($file, $name,
                $headers, $disposition);
        }
        ...
        public static function redirectTo(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectTo($path,
        ...
        public static function redirectToRoute(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToRoute($route,
        ...
        public static function redirectToAction(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToAction($action,
                $parameters, $status, $headers);
        }
        ...
        public static function redirectGuest(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectGuest($path,
                $status, $headers, $secure);
        }
        ...
        public static function redirectToIntended(
            ...
            return \Illuminate\Routing\ResponseFactory::redirectToIntended($default,
                $status, $headers, $secure);
        }
    ...
    class Route extends \Illuminate\Support\Facades\Route
    {
        ...
        /**
         * Resolve the middleware name to a class name(s) preserving passed
         * parameters.
         *
         * @param string $name
         *
        ...
        {
            return \Illuminate\Routing\Router::middlewareGroup($name,
                $middleware);
        }
         ...
         *
         * If the middleware is already in the group, it will not be added
         * again.
         *
         * @param string $group
        ...
        {
            return \Illuminate\Routing\Router::prependMiddlewareToGroup($group,
                $middleware);
        }
        ...
        {
            return \Illuminate\Routing\Router::pushMiddlewareToGroup($group,
                $middleware);
        }
        ...
        {
            return \Illuminate\Routing\Router::prepareResponse($request,
                $response);
        }
    ...
    class Schema extends \Illuminate\Support\Facades\Schema
    {
        ...
        public static function hasColumn($table, $column)
        {
            ...
            return \Illuminate\Database\Schema\MySqlBuilder::hasColumn($table,
                $column);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Illuminate\Database\Schema\MySqlBuilder::hasColumns($table,
                $columns);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Illuminate\Database\Schema\MySqlBuilder::getColumnType($table,
                $column);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Illuminate\Database\Schema\MySqlBuilder::table($table,
                $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Illuminate\Database\Schema\MySqlBuilder::create($table,
                $callback);
        }
    ...
    class Session extends \Illuminate\Support\Facades\Session
    {
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \Illuminate\Session\SessionManager::extend($driver,
                $callback);
        }
         ...
         *
         * @param int $lifetime Sets the cookie lifetime for the session
         *                      cookie. A null value will leave the system
         *                      settings unchanged, 0 sets the cookie to expire
         *                      with browser session. Time is in seconds, and
        ...
        /**
         * Migrates the current session to a new session id while maintaining
         * all session attributes.
         *
         * @param bool $destroy  Whether to delete the old session or leave it
         *                       to garbage collection.
         * @param int  $lifetime Sets the cookie lifetime for the session
         *                       cookie. A null value will leave the system
         *                       settings unchanged, 0 sets the cookie to
         *                       expire with browser session. Time is in
         *                       seconds, and is not a Unix timestamp.
         *
    ...
    class Storage extends \Illuminate\Support\Facades\Storage
    {
        ...
        public static function extend($driver, $callback)
        {
            return \Illuminate\Filesystem\FilesystemManager::extend($driver,
                $callback);
        }
    ...
    class URL extends \Illuminate\Support\Facades\URL
    {
        ...
        /**
         * Generate a URL to an asset from a custom root domain such as CDN,
         * etc.
         *
         * @param string    $root
         * @param string    $path
        ...
        {
            return \Illuminate\Routing\UrlGenerator::assetFrom($root, $path,
                $secure);
        }
        ...
        {
            return \Illuminate\Routing\UrlGenerator::route($name, $parameters,
                $absolute);
        }
        ...
        public static function action(
            ...
            return \Illuminate\Routing\UrlGenerator::action($action,
                $parameters, $absolute);
        }
    ...
    class Validator extends \Illuminate\Support\Facades\Validator
    {
        ...
        public static function make(
            ...
            return \Illuminate\Validation\Factory::make($data, $rules,
    ...
    class View extends \Illuminate\Support\Facades\View
    {
        ...
        public static function renderEach(
            ...
            return \Illuminate\View\Factory::renderEach($view, $data, $iterator,
                $empty);
        }
        ...
        public static function addExtension(
            ...
            \Illuminate\View\Factory::addExtension($extension, $engine,
                $resolver);
        }
